    ...
    <div className='add'>
      <form onSubmit={onSubmitHandler} className="flex-col">
        <div className="add-img-upload flex-col">
          ...
          <input className='upload-img' onChange={(e) => setImage(e.target.files[0])} type="file" id='image' required />
        </div>
        ...
        <div className="add-product-description flex-col">
          <p>Add Description</p>
          <textarea onChange={onChangeHandler} value={data.description} name="description" rows="8" placeholder='Add description' required></textarea>
        </div>
